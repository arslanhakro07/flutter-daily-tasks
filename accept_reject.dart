...
class accep_reject extends StatelessWidget {
  const accep_reject({super.key});

  @override
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text("Friends Requests", style: GoogleFonts.poppins(color: Colors.white)),
        centerTitle: true,
        ...
        child: Column(
          children: [
                        ...
                        Padding(padding: EdgeInsets.only(top: 0),
                          child: ListTile(leading: Container(height: 60,width: 60,
                            ...
                            trailing: Column(children: [
                              ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.green,minimumSize: Size(20, 20)),
                                  onPressed: (){}, child: Text("Accept",style: TextStyle(color: Colors.white),)),
                              SizedBox(height: 8,),
                              ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.red,minimumSize: Size(20, 20)),
            ...
            ElevatedButton(style: ElevatedButton.styleFrom(backgroundColor: Colors.deepPurple),
                onPressed: (){}, child: Text("Send a friend request",style: TextStyle(color: Colors.white),))
          ],
        ),
      ) ,
    );;
